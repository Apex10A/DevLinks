    ...
    <div className='bg-[#FAFAFA]'>
       ...
       <div className='bg-[#FAFAFA]  flex flex-col items-center justify-center mx-[20px] md:mx-[40px] px-4 md:px-10 py-10 mt-5'>
        <div className='max-w-xl flex flex-col items-center justify-between pt-10'>
            ...
            <input type="text" name="" className='border border-[#D9D9D9] bg-[#fff] flex items-center justify-between  rounded-[8px] py-[5px] px-[16px]' placeholder='e.g. John' id="" />
            </div>
        </div>
        <div className=' flex flex-col items-center justify-between pt-10'>
            <div className='flex items-center justify-between'>
            <p className='text-[16px] font-[400] text-[#737373]'>Last name*</p>
            <input type="text" name="" className='border border-[#D9D9D9] bg-[#fff] flex items-center justify-between  rounded-[8px] py-[5px] px-[16px]' placeholder='e.g. Appleseed' id="" />
            </div>
        </div>
        <div className=' flex items-center justify-between pt-10'>
            <div className='flex items-center justify-between'>
            <p className='text-[16px] font-[400] text-[#737373]'>Email*</p>
            <input type="email" name="" className='border border-[#D9D9D9] bg-[#fff] flex items-center justify-between  rounded-[8px] py-[5px] px-[16px]' placeholder='e.g. email@example.com' id="" />
            </div>
        </div>
       </div>
